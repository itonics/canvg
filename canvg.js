 ...
 */
 (function ( global, factory ) {
  ...
  var kernings = [{ c1: 'A', c2: 'C', kern: -21 },
{ c1: 'A', c2: 'G', kern: -31 },
{ c1: 'A', c2: 'O', kern: -31 },
{ c1: 'A', c2: 'Q', kern: -31 },
{ c1: 'A', c2: 'T', kern: -62 },
      ...
      this.getAnchorDelta = function (ctx, parent, startI) {
        ...
        if (textAnchor != 'start') {
          ...
          for (var i=startI; i<parent.children.length; i++) {
            ...
            width += child.measureTextRecursive ? child.measureTextRecursive(ctx) : 0;
          }
    ...
    svg.Element.a.prototype = new svg.Element.TextElementBase;
        ...
        svg.Element.textPath = function (node) {
            ...
            this.setTextData = function (ctx) {
                ...
                var findSegmentToFitChar = function (c, charI, kern) {
                ...
                kernings.forEach(function (kerning) {
                  kerningTable[kerning.c1] = kerningTable[kerning.c1] || {};
                  kerningTable[kerning.c1][kerning.c2] = kerning.kern;
                });
                ...
                for (var i = 0; i < charArr.length; i++) {
                    ...
                    var segment = findSegmentToFitChar(charArr[i], i, kerning(charArr[i], charArr[i + 1]));
